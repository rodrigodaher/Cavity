...
module global
    ...
    real*16 :: A_x, D_x, A_y, D_y, P_x, P_y, rho, mi, gama, V_tampa, teste
...
subroutine boundary_conditions()
    ...
    do i = 2, m-2
        u(1, i) = 2.0d0 * V_tampa - u(2, i)                                              !U Velocity on the up wall
        u_int(1, i) = 2.0d0* V_tampa - u_int(2, i)                                       !U* velocity on the up wall   
